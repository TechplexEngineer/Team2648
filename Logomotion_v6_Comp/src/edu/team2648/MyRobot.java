...
//						drive.stop();// from 1.5
						...
						drive.goForwardSlow();
						Timer.delay(1); //changed from .28 // .35 //////.85 //.975
						drive.stop();
...
//				} else if (lft && !rt)
//				{
//					drive.setLeftRightMotorSpeeds(0, -.375);
//					System.out.println("lft");
//				} else if (!lft && rt)
//				{
//					drive.setLeftRightMotorSpeeds(-.375, 0);
//					System.out.println("rt");
//				} else if (lft && rt)
//				{
//					System.out.println("TTTTTTTTTTTTTT");
...
//					System.out.println("Forward Slow");
//					drive.goForwardSlow();
//					Timer.delay(1.5); //changed from .28 // .35 //////.85 //.975
//					drive.stop();
//
//					if (timer.get() > 15)
//					{
...
//					}
						...
						System.out.println("Going RT Slow");
						drive.stop();
						drive.goRight();
						Timer.delay(.375); //was .75
						drive.stop();
